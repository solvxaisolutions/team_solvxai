...
import Bot from "../splineComponent/bot";
...
const Home = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "AI Solutions",
      description:
        "Cutting-edge artificial intelligence solutions to automate and optimize your business.",
    },
    {
  ...
  const features = [
    {
      ...
      title: "Fast Delivery",
      description:
        "Quick turnaround times without compromising on quality. We deliver projects on schedule.",
    },
    {
      icon: <Shield className="w-12 h-12" />,
      title: "Secure Solutions",
      description:
        "Enterprise-grade security measures to protect your data and user information.",
    },
    {
      icon: <Target className="w-12 h-12" />,
      title: "Goal-Oriented",
      description:
        "Every project is designed with your business objectives and ROI in mind.",
    },
    {
  ...
  const testimonials = [
    {
      ...
      content:
        "SolvxAI transformed our digital presence completely. Their team delivered beyond our expectations with exceptional quality and professionalism.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "Working with SolvxAI was a game-changer for our startup. They built us a scalable platform that grows with our business needs.",
      rating: 5,
    },
    {
      ...
      content:
        "The mobile app they developed for us increased our user engagement by 300%. Absolutely incredible results and ongoing support.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="scroll-smooth">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-left">
              ...
              <p
                className={`text-xl mb-8 max-w-2xl leading-relaxed animate-slide-up ${
                  isDarkMode ? "text-gray-300" : "text-gray-600"
                }`}
              >
                We help businesses harness the power of technology to streamline
                operations, scale efficiently, and stay competitive in a
                fast-changing world.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-slide-up">
                ...
                <button
                  className={`px-8 py-4 rounded-full font-semibold flex items-center justify-center space-x-2 transition-all duration-300 ${
                    isDarkMode
            ...
            <div className="relative animate-slide-up hidden md:block">
              <div className="relative">
                ...
                {/* Floating Stats Card */}
                <div
                  className={`absolute -bottom-6 -right-28 p-6 rounded-2xl shadow-xl animate-float ${
                    isDarkMode
                      ? "glass-morphism"
                ...
                <div
                  className={`absolute top-6 left-14 p-4 rounded-full shadow-xl animate-bounce-slow ${
                    isDarkMode
                      ? "glass-morphism"
                      : "bg-white border border-gray-200"
                  }`}
      ...
      {/* Services Section */}
      <section
        className={`py-20 ${isDarkMode ? "bg-dark-800" : "bg-white"}`}
        ref={servicesRef}
      >
      ...
      {/* Features Section */}
      <section
        className={`py-20 ${isDarkMode ? "bg-dark-900" : "bg-gray-50"}`}
        ref={featuresRef}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            businesses with our expert solutions. Let's discuss your project
            today.
          </p>
